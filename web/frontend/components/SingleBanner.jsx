...
//                     ) : (
//                       <img className="productImgCls" alt={selectedProduct.title} src="default-image-url" />
//                     )}
//                   </span>
//                 </div>
//                 <div className="Polaris-LegacyStack__Item">
...
//                     ) : (
//                       <img className="collectionImgCls" alt={selectedCollection.title} src="default-image-url" />
//                     )}
//                   </span>
//                 </div>
//                 <div className="Polaris-LegacyStack__Item">
                      ...
                      <span className="Polaris-Choice__Control">
                        <span className="Polaris-RadioButton">
                          <input
                            ...
                            value="collection"
                            checked={linkType === 'collection'}
                            onChange={() => handleLinkTypeChange('collection')}
                          />
                          <span className="Polaris-RadioButton__Backdrop"></span>
                        </span>
                      </span>
...
// this code is working for icons also whic is wokrking on 1/11/2024
