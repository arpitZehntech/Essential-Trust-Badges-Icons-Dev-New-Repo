...
// Working  code at 19-11-2024 for link to selection for single selection 
                  ...
                  <li>
                    <div className="Polaris-Bleed" style={{ "--pc-bleed-margin-block-end-xs": "var(--p-space-0)" }}>
                      <label className="Polaris-Choice" htmlFor="PolarisRadioButton50">
                        <span className="Polaris-Choice__Control">
                          <span className="Polaris-RadioButton">
                            <input id="PolarisRadioButton50" name="PolarisChoiceList13" type="radio" className="Polaris-RadioButton__Input" value="product" checked={linkType === 'product'} onChange={() => handleLinkTypeChange('product')} />
                            <span className="Polaris-RadioButton__Backdrop"></span>
                          </span>
                        </span>
                        <span className="Polaris-Choice__Label">
                  ...
                  <li>
                    <div className="Polaris-Bleed" style={{ "--pc-bleed-margin-block-end-xs": "var(--p-space-0)" }}>
                      <label className="Polaris-Choice" htmlFor="PolarisRadioButton51">
                        <span className="Polaris-Choice__Control">
                          <span className="Polaris-RadioButton">
                            <input id="PolarisRadioButton51" name="PolarisChoiceList13" type="radio" className="Polaris-RadioButton__Input" value="collection" checked={linkType === 'collection'} onChange={() => handleLinkTypeChange('collection')} />
                            <span className="Polaris-RadioButton__Backdrop"></span>
                          </span>
                        </span>
                        <span className="Polaris-Choice__Label">
                  ...
                  <li>
                    <div className="Polaris-Bleed" style={{ "--pc-bleed-margin-block-end-xs": "var(--p-space-0)" }}>
                      <label className="Polaris-Choice" htmlFor="PolarisRadioButton52">
                        <span className="Polaris-Choice__Control">
                          <span className="Polaris-RadioButton">
                            <input id="PolarisRadioButton52" name="PolarisChoiceList13" type="radio" className="Polaris-RadioButton__Input" value="external" checked={linkType === 'external'} onChange={() => handleLinkTypeChange('external')} />
                            <span className="Polaris-RadioButton__Backdrop"></span>
                          </span>
                        </span>
                        <span className="Polaris-Choice__Label">
