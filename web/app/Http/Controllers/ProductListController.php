    ...
    public function getCollections(Request $request)
{
    ...
    try {
        // Get collections from the Shopify store using the correct API endpoint
        $result = $client->get('admin/api/2024-01/collections.json');

        // Return the collections list as a JSON response
        return response()->json($result->getDecodedBody());
    } catch (\Exception $e) {
        // Handle any errors that occur during the API request
        return response()->json([
