...
// testing 16-11-2024 for css by js
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        const containerDivs = document.querySelectorAll('.container-div, .container-div1');
        containerDivs.forEach(containerDiv => {
            if (containerDiv.classList.contains('container-div') || containerDiv.classList.contains('container-div1')) {
                applyDynamicStyles(containerDiv, {
                    'grid-column': '1 / -1'
                });
            }
...
//             'max-width': '100%'
//         });
//         subheading.innerText = page.subheading || '';

//         // Append title and subheading to text container
//         textContainer.appendChild(title);
//         textContainer.appendChild(subheading);
...
//             color: 'white'
//         });
//         ctaButton.href = page.cta_link || '#';
//         ctaButton.target = '_blank';
//         ctaButton.innerText = page.cta_text || 'Learn More';
...
//     // Function to apply dynamic styles using JavaScript
//     function applyDynamicStyles(element, styles) {
